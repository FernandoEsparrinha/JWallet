...
public class Wallet implements Serializable {
    ...
    public void addDeposit(float amount, String reason) {
        Deposit deposit = new Deposit(amount, reason);
        this.setBalance(this.getBalance() + amount);
        this.getDeposits().add(deposit);
    }

    public void addWithdraw(float amount, String reason) {
        Withdraw withdraw = new Withdraw(amount, reason);
        this.setBalance(this.getBalance() - amount);
        this.setSpendings(this.getSpendings() + amount);
        this.getWithdraws().add(withdraw);
    }
